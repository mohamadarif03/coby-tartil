...
function Hijaiyah() {
  ...
  useAccessibility('Daftar Huruf Hijaiyah'); // ADDED
  return (
    <div className="bg-[#f3f7fb] text-[#2a2f32] min-h-screen siswa-body siswa-headline flex">
      <Sidebar activeMenu="iqra" />

      {/* Main Content Canvas */}
      <main className="ml-72 p-10 max-w-7xl mx-auto w-full" id="main-content" role="main"> {/* ADDED */}
        {/* Breadcrumb */}
        <nav aria-label="Breadcrumb" className="flex items-center space-x-2 text-sm font-medium text-slate-500 mb-8">
          <a className="hover:text-[#006b5c] transition-colors cursor-pointer" onClick={() => navigate('/siswa')}>Beranda</a>
          <span className="material-symbols-outlined text-base">chevron_right</span>
          <a className="hover:text-[#006b5c] transition-colors cursor-pointer" onClick={() => navigate('/iqra')}>Iqra'</a>
          <span className="material-symbols-outlined text-base">chevron_right</span>
          <span className="text-[#006b5c] font-bold">Huruf Hijaiyah</span>
        </nav>
        ...
        <section className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3">
              <span className="px-4 py-1 bg-[#5de3fc]/30 text-[#006b5c] font-bold rounded-full text-sm">Progress Kamu</span>
              <span className="text-2xl font-black text-[#006b5c]">5 <span className="text-slate-400 font-medium">/ 28</span></span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Card 1: Completed */}
          <button aria-label="Huruf Alif, sudah selesai" onClick={() => navigate('/iqra/hijaiyah/alif')} className="group relative bg-[#dde3e8] rounded-xl p-8 flex flex-col items-center justify-center transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-[#006b5c]/10 focus:outline-none focus:ring-4 focus:ring-[#D4A017] focus:ring-offset-2">
            <div className="absolute top-4 right-4 text-[#006b5c]">
              <span className="material-symbols-outlined text-3xl" style={{ fontVariationSettings: "'FILL' 1" }}>check_circle</span>
            </div>
            <span className="font-['Noto_Sans_Arabic'] text-7xl mb-4 text-[#2a2f32]">ا</span>
            <span className="font-['Plus_Jakarta_Sans'] font-bold text-xl text-[#006b5c]">Alif</span>
            <div className="mt-4 px-4 py-1 bg-[#006b5c] text-[#dbf8ff] text-xs font-bold rounded-full">Selesai</div>
          </button>

          {/* Card 2: Completed */}
          <button aria-label="Huruf Ba, sudah selesai" onClick={() => navigate('/iqra/hijaiyah/ba')} className="group relative bg-[#dde3e8] rounded-xl p-8 flex flex-col items-center justify-center transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-[#006b5c]/10 focus:outline-none focus:ring-4 focus:ring-[#D4A017] focus:ring-offset-2">
            <div className="absolute top-4 right-4 text-[#006b5c]">
              <span className="material-symbols-outlined text-3xl" style={{ fontVariationSettings: "'FILL' 1" }}>check_circle</span>
            </div>
            <span className="font-['Noto_Sans_Arabic'] text-7xl mb-4 text-[#2a2f32]">ب</span>
            <span className="font-['Plus_Jakarta_Sans'] font-bold text-xl text-[#006b5c]">Ba</span>
            <div className="mt-4 px-4 py-1 bg-[#006b5c] text-[#dbf8ff] text-xs font-bold rounded-full">Selesai</div>
          </button>

          {/* Card 3: Completed */}
          <button aria-label="Huruf Ta, sudah selesai" onClick={() => navigate('/iqra/hijaiyah/ta')} className="group relative bg-[#dde3e8] rounded-xl p-8 flex flex-col items-center justify-center transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-[#006b5c]/10 focus:outline-none focus:ring-4 focus:ring-[#D4A017] focus:ring-offset-2">
            <div className="absolute top-4 right-4 text-[#006b5c]">
              <span className="material-symbols-outlined text-3xl" style={{ fontVariationSettings: "'FILL' 1" }}>check_circle</span>
            </div>
            <span className="font-['Noto_Sans_Arabic'] text-7xl mb-4 text-[#2a2f32]">ت</span>
            <span className="font-['Plus_Jakarta_Sans'] font-bold text-xl text-[#006b5c]">Ta</span>
            <div className="mt-4 px-4 py-1 bg-[#006b5c] text-[#dbf8ff] text-xs font-bold rounded-full">Selesai</div>
          </button>

          {/* Card 4: Locked */}
          <button aria-label="Huruf Tsa, belum terbuka" className="group relative bg-[#ffffff] rounded-xl p-8 flex flex-col items-center justify-center transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-slate-200 focus:outline-none focus:ring-4 focus:ring-[#D4A017] focus:ring-offset-2">
          ...
          {/* Card 5: Current/Next */}
          <button aria-label="Huruf Jim, mulai belajar" onClick={() => navigate('/iqra/hijaiyah/jim')} className="group relative bg-[#ffffff] rounded-xl p-8 flex flex-col items-center justify-center ring-4 ring-[#006b5c] ring-offset-4 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-[#006b5c]/20 focus:outline-none focus:ring-4 focus:ring-[#D4A017] focus:ring-offset-2">
          ...
          {/* Card 8: Locked */}
          <button aria-label="Huruf Dal, belum terbuka" className="group relative bg-[#ffffff] rounded-xl p-8 flex flex-col items-center justify-center transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-slate-200 focus:outline-none focus:ring-4 focus:ring-[#D4A017] focus:ring-offset-2"> {/* ADDED: focus ring */}
            <div className="absolute top-4 right-4 text-slate-300">
              <span className="material-symbols-outlined text-3xl">lock</span>
            </div>
        ...
        {/* Mascot Floating UI */}
        <div className="fixed bottom-12 right-12 flex items-end gap-4 z-40" aria-hidden="true"> {/* ADDED: aria-hidden */}
