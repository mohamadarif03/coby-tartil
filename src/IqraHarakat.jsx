      ...
      <main className="ml-72 p-6 md:p-10 pb-32 w-full" id="main-content" role="main">
        <div className="max-w-5xl mx-auto">
          ...
          <nav aria-label="Breadcrumb" className="flex items-center space-x-2 text-sm font-medium text-slate-500 mb-8">
            ...
            <span className="material-symbols-outlined text-base">chevron_right</span>
            <span className="text-[#006b5c] font-bold">Harakat</span>
          </nav>
          ...
          <section className="mb-10">
            <div className="flex items-center gap-4 mb-3">
              <div className="w-14 h-14 rounded-2xl bg-blue-100 flex items-center justify-center">
                <span className="material-symbols-outlined text-3xl text-blue-600" style={{ fontVariationSettings: "'FILL' 1" }}>edit_note</span>
              </div>
              <div>
                <h2 className="text-4xl font-black text-[#2a2f32] font-['Plus_Jakarta_Sans'] tracking-tight">Harakat</h2>
                <p className="text-slate-500 font-medium">Tanda Baca dalam Al-Qur'an</p>
              </div>
            </div>
          </section>
            ...
            <div className="lg:col-span-4">
              <div className={`${active.bgColor} rounded-2xl p-8 border ${active.textColor.replace('text', 'border')}/20 relative overflow-hidden`}>
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-slate-600 mt-2 font-medium">Bunyi: "{active.sound}"</p>
                </div>
              ...
              <div className="mt-8 bg-white rounded-2xl p-8 border border-slate-100 shadow-sm">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-xl bg-amber-100 flex items-center justify-center">
                    <span className="material-symbols-outlined text-xl text-amber-600" style={{ fontVariationSettings: "'FILL' 1" }}>quiz</span>
                  </div>
                  <h4 className="text-lg font-bold text-[#2a2f32] font-['Plus_Jakarta_Sans']">Latihan Cepat</h4>
                </div>
                <p className="text-slate-500 text-sm mb-6">Klik huruf di atas untuk mendengarkan pelafalannya, lalu coba ucapkan sendiri!</p>
                
                <div className="flex flex-wrap gap-3">
                  <div className="px-4 py-2 rounded-full bg-teal-50 text-teal-700 text-sm font-semibold border border-teal-200">
                    ✅ Dengarkan suara
                  </div>
                  <div className="px-4 py-2 rounded-full bg-blue-50 text-blue-700 text-sm font-semibold border border-blue-200">
                    🎤 Ucapkan sendiri
                  </div>
                  <div className="px-4 py-2 rounded-full bg-violet-50 text-violet-700 text-sm font-semibold border border-violet-200">
                    🔁 Ulangi sampai benar
                  </div>
                </div>
              </div>
