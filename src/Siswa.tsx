...
function Siswa() {
  ...
  return (
    <div className="bg-[#f3f7fb] text-[#2a2f32] min-h-screen siswa-body siswa-headline flex">
      ...
      {/* Main Content Area */}
      <main className="ml-72 p-8 lg:p-12 w-full" id="main-content" role="main">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12" aria-labelledby="progress-heading">
      ...
      <div className="fixed bottom-8 right-8 flex flex-col items-end z-40" aria-hidden="true">
      ...
      {/* Background Elements */}
      <div className="fixed top-0 right-0 -z-10 opacity-20 pointer-events-none" aria-hidden="true">
