...
export const Route = createFileRoute('/_teacher-dashboard/guru/')({
          ...
          <div className="bg-[#800000] p-6 rounded-xl shadow-sm border border-[#a9aeb1]/10 min-w-50 text-center">
            {countLoading ? (
              <div className="flex items-center justify-center py-2">
                <span className="inline-block w-8 h-8 border-2 rounded-full border-white/30 border-t-white animate-spin" />
              </div>
            ) : (
              <>
