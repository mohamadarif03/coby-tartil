...
export const Route = createFileRoute('/_student-dashboard/siswa/iqra/hijaiyah/$letter/isyarat/')({
  component: DetailHijaiyahIsyarat,
})

function DetailHijaiyahIsyarat() {
    const navigate = useNavigate();
    const { letter } = useParams({ from: '/_student-dashboard/siswa/iqra/hijaiyah/$letter/isyarat/' });
