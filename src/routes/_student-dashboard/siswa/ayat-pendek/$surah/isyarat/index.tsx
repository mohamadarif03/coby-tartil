...
export const Route = createFileRoute('/_student-dashboard/siswa/ayat-pendek/$surah/isyarat/')({
  component: DetailAyatIsyarat,
})

function DetailAyatIsyarat () {
    const navigate = useNavigate();
    const { surah } = useParams({ from: '/_student-dashboard/siswa/ayat-pendek/$surah/isyarat/' });
    ...
    const handleNext = () => {
        ...
        else navigate({ to: '/siswa/ayat-pendek' });
    };

    const handlePrev = () => {
        if (isFirst) navigate({ to: '/siswa/ayat-pendek' });
        ...
        <div className="bg-[#f3f7fb] text-[#2a2f32] min-h-screen siswa-body flex">
            <main className="w-full p-6 pb-32 ml-0 lg:ml-72 md:p-12" id="main-content" role="main">
                ...
                <nav className="mb-8 flex items-center gap-2 text-sm text-[#575c60] font-medium">
                    ...
                    <span className="text-sm material-symbols-outlined">chevron_right</span>                        <span onClick={() => navigate({ to: '/siswa/ayat-pendek' })} className="hover:text-[#800000] cursor-pointer transition-colors" tabIndex="0">Ayat Pendek</span>
                    <span className="text-sm material-symbols-outlined">chevron_right</span>                        <span onClick={() => navigate({ to: '/siswa/ayat-pendek/$surah', params: { surah } })} className="hover:text-[#800000] cursor-pointer transition-colors" tabIndex="0">{currentSurah.name}</span>
                        ...
                        <div>
                            <div className="flex items-center gap-3 mb-2">
                                <span className="px-4 py-1.5 bg-[#ffd700]/20 text-[#b18b10] text-xs font-black uppercase tracking-widest rounded-full flex items-center gap-2">
                                    <span className="text-sm material-symbols-outlined">sign_language</span>
                                    Mode Isyarat
                                </span>
                ...
                <div className="grid items-start max-w-6xl grid-cols-1 gap-8 mx-auto lg:grid-cols-12">
                    ...
                    <div className="space-y-6 lg:col-span-7">
                        ...
                        <div className="flex items-center justify-between gap-4">
                            ...
                            <button
                                onClick={() => navigate({ to: '/siswa/ayat-pendek/$surah', params: { surah } })}
                            ...
                            >
                                <span className="text-lg material-symbols-outlined">mic</span>
                                Mode Suara
                            </button>
                            <button
                                onClick={handleNext}
